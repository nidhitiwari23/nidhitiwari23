...
- 🎓 Pursuing an **M.Sc. in Data Science** at **SVKM's NMIMS, Mumbai**
- 🤖 Passionate about **Artificial Intelligence, Machine Learning, Generative AI, and Agentic AI**
- 🔭 Currently building end-to-end AI applications using **LangChain, LangGraph, FastAPI, RAG, MCP, and Vector Databases**
- 🌱 Exploring **AI Agents, Multi-Agent Systems, LLM Engineering, Model Context Protocol (MCP), and Production AI Systems**
